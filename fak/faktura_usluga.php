...
if (isset($_GET['broj_fak_stampa'])) {
	...
	<div class="nosac_sa_tabelom">
		...
		<div class="nosac_zaglavlja_fakture screen_hide">
			<div class="zaglavlje_fakture_levi"><span style="font-size: 15px;"><b>RAČUN br. <?php echo $racun_rucni."/".$trengodina;?></b></span>
		...
		<table>
			...
			$prikaz_roba_upit = mysql_query("SELECT izlaz.id, izlaz.br_dos, izlaz.srob_dos, izlaz.koli_dos, izlaz.cena_d, izlaz.rab_dos,
								...
								))*izlaz.koli_dos) AS ukupdospor, roba.jed_mere, roba.usluga_opis
			...
			<tr>
				...
				<td style="text-align:left;"><?php echo $prikaz_roba_red['usluga_opis'];?></td>
			...
			if ($rabat_provera_postojanja_red['ukuprab'] != 0){ ?>
			<tr>
				<td rowspan='7' colspan='1' style="border:none;"></td>
