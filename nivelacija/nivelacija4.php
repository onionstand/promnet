  ...
  <body>
    ...
    <div class="nosac_sa_tabelom">
      ...
      <table>
        ...
        <?php
        $upit2 = mysql_query("
        SELECT niv_robe.id, niv_robe.srob, niv_robe.srob_niv, niv_robe.koli_niv, roba.naziv_robe, roba.cena_robe FROM niv_robe
        RIGHT JOIN roba ON niv_robe.srob=roba.sifra
        WHERE br_niv='$br_niv'
        ");
        $upit3 = mysql_query("
        SELECT niv_robe.srob, niv_robe.srob_niv, niv_robe.koli_niv, roba.naziv_robe, roba.cena_robe FROM niv_robe
      ...
      <form action="nivelacija1.php" method="post">
        ...
        <button type='submit' class='dugme_zeleno'>Dodaj robu</button>
      </form>
      <button onClick='window.print()' type='button' class='dugme_plavo'>Stampaj</button>
